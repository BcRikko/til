...
ただし、執筆時点（2026年5月）では[Firefox 151](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/151)でのみサポートされている。FirefoxでkeyboardLockオプションを指定するとフルスクリーン時に「Exit Full Screen (Press and hold esc)」と表示される。
